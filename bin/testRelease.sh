...
coursier fetch \
  ...
  com.lihaoyi:utest_sjs0.6_2.13.0-RC1:$VERSION \
  com.lihaoyi:utest_sjs1.0.0-RC1_2.11:$VERSION \
  com.lihaoyi:utest_sjs1.0.0-RC1_2.12:$VERSION \
  -r sonatype:releases
  # com.lihaoyi:utest_sjs1.0.0-RC1_2.13.0-RC1:$VERSION \ # Did not release
